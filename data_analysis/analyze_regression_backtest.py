...
try:
    ...
    logging.debug(f"Successfully loaded data from {RESULTS_FILE}. Shape: {results_df.shape}")
except FileNotFoundError:
    logging.debug(f"Error: The file '{RESULTS_FILE}' was not found. Please ensure it has been generated by 'run_regression_backtest()'.")
    exit()
...
logging.debug("\nError Statistics:")
logging.debug(results_df[['error', 'absolute_error', 'percentage_error', 'absolute_percentage_error']].describe())
...
logging.debug("Threshold for Up/Down signal: +/- {:.2f}%".format(binarization_threshold * 100))
