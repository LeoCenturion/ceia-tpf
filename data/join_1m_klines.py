...
# --- Argument Parser ---
parser = argparse.ArgumentParser(description="Consolidate multiple 1-minute kline CSV files into a single file.")
parser.add_argument("data_dir", help="Directory containing the 1-minute kline CSV files.")
