...
def run_cpcv_for_chronos_pipeline(
...
def main():
    ...
    raw_data = fetch_historical_data(
        ...
        timeframe="1m",
        data_path=data_path,
        start_date="2023-01-01T00:00:00Z",  # Use a smaller subset for quicker testing
    )
    ...
    path_scores = run_cpcv_for_chronos_pipeline(
        pipeline=pipeline,
        raw_data=raw_data,
        model_cls=AutoGluonAdapter,
        model_params=model_params,
        experiment_name="Chronos_CPCV_Backtest",
    )
