...
from src.backtesting.strategies.cpcv_strategies import BollingerBandsCPCV
...
def run(
    ...
    experiment_name: str = "CPCV_BollingerBands",
):
    ...
    return run_cpcv_for_strategy(
        data=data,
        t1=t1,
        strategy_class=BollingerBandsCPCV,
        strategy_params={"bb_window": bb_window, "bb_std": bb_std},
        n_groups=n_groups,
...
def main():
    parser = argparse.ArgumentParser(description="CPCV for BollingerBands")
    ...
    parser.add_argument("--bb-std", type=float, default=2.0, help="Number of std deviations")
    ...
    parser.add_argument("--experiment-name", default="CPCV_BollingerBands")
