...
class XGBoostPriceReversalStrategy(Strategy):
    ...
    def get_optuna_params(cls, trial):
        return {
            ...
            "peak_threshold": trial.suggest_float('peak_threshold', 0.3088073570333899, 0.3088073570333899),
            "corr_threshold": trial.suggest_float('corr_threshold', 0.24234536219482808, 0.24234536219482808),
            "n_estimators": trial.suggest_int('n_estimators', 154, 154),
            "learning_rate": trial.suggest_float('learning_rate', 0.1187900234174778, 0.1187900234174778),
            "max_depth": trial.suggest_int('max_depth', 10, 10),
            "subsample": trial.suggest_float('subsample', 0.5591095634844386, 0.5591095634844386),
            "colsample_bytree": trial.suggest_float('colsample_bytree', 0.8383126666102035, 0.8383126666102035),
            "gamma": trial.suggest_float('gamma', 0.11692201750072992, 0.11692201750072992),
