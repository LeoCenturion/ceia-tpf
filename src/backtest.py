...
class TradingBacktester:
    ...
    def moving_average_crossover_strategy(self, 
                                          data: pd.DataFrame, 
                                          short_window: int = 50, 
        ...
        # Generate signals
        signals[short_window:][data['MA_short'][short_window:] > data['MA_long'][short_window:]] = 1  # Long
        signals[short_window:][data['MA_short'][short_window:] < data['MA_long'][short_window:]] = -1  # Short
    ...
    def backtest(self, 
            ...
            if position != 0:
                if position > 0:  # Long position
                    ...
                    if (entry_price / current_price - 1) <= -stop_loss or \
                       (entry_price / current_price - 1) >= take_profit:
        ...
        total_return = (balance_history[-1] - self.initial_balance) / self.initial_balance * 100
